...
@DesignerComponent(
        version = 1,
        description = "This AIX is developed by Logical Devz Team. Its is free and open source. You can download this aix from Logical Devz Store.This extension allows you to send email to users from your app. there are many email customizations also there is HTML text support.",
